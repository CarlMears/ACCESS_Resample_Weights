    ...
    integer(int32),parameter :: num_target_scans = 4  ! 3 extra scan
    integer(int32),parameter :: num_target_fovs = 253 ! 4 extra FOVS
    integer(int32),parameter :: num_source_scans = 29 ! +/- 14 scans
    integer(int32),parameter :: num_source_fovs = 64
    ...
    9077 format('/mnt/ops1p-ren/l/ACCESS/resampling/SSMI/f',i2.2, &
    ...
    9013 format('/mnt/ops1p-ren/l/ACCESS/resampling/SSMI/f',i2.2,'/target_gains/locs/find_target_gain_f', &
                        i2.2,'_circular.loc')

    write(source_location_file,9023) ksat,ksat,ifreq
    9023 format('/mnt/ops1p-ren/l/ACCESS/resampling/SSMI/f',i2.2,'/source_gains/locs/find_source_gain_f', &
    ...
    9033 format('/mnt/ops1p-ren/l/ACCESS/resampling/SSMI/f',i2.2,'/source_gains/g_everywhere/g_everywhere_SSMI_freq_',i2.2,'.dat')
    open(unit=3, &
    ...
    do target_scan_to_do = 1,num_target_scans
        ...
        9001 format('/mnt/ops1p-ren/l/access/resampling/ssmi/f',I2.2,'/resample_gains/',i2.2,&
    ...
    555 format('/mnt/ops1p-ren/l/ACCESS/resampling/SSMI/f',i2.2,'/resample_weights/',i2.2,&
