module ssmis_gains
    ...
    public read_gain_obs_ssmis,read_gain_target_ssmis

contains
    subroutine read_gain_obs_ssmis(ksat,ifreq,iscan,icel,g_compact)
    ...
    subroutine read_gain_target_ssmis(idiameter,ksat,ifreq,iscan,icel,g_compact)
        ...
        9002 format('/mnt/ops1p-ren/l/access/resampling/SSMIS/f',i2.2,'/target_gains/', &
