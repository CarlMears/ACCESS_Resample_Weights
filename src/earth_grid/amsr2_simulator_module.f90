!     6/1/2021 Modeled on mwi simulator module, but modified to reflect AMSR2
!
!    
...
!     nch is now 10, not 12
    ...
    module l2_module
    use sensor_module  !should include amsr2_sensor_module in project
    implicit none
...
!    earth dimensions match wgs84    
    ...
    real(8),    parameter :: orbit_period = 5929.564d0 ! from jan 2020 TLE  !orbital period
    ...
    real(4), parameter :: ta_earth_min(nch)= &
          (/ 55., 55., 55., 55., 55., 55., 55., 55., 55., 55., 55., 55., 55., 55., 55., 55./)
    real(4), parameter :: ta_earth_max(nch)= &
